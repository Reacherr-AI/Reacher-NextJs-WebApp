...
export default function VerifyEmailPage() {
  ...
  return (
    <div className="min-h-screen bg-black px-6 pb-16 pt-10 text-white">
      <div className="mx-auto w-full max-w-[520px] rounded-3xl border border-white/10 bg-white/5 p-8 shadow-[0_40px_120px_rgba(6,7,33,0.45)]">
        ...
        <form onSubmit={handleSubmit} className="mt-6">
          <label className="text-xs font-semibold text-white/70">Email OTP</label>
          <input
            type="text"
            placeholder="123456"
            value={otp}
